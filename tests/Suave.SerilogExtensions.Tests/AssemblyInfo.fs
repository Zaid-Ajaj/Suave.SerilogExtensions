...
[<assembly: AssemblyTitleAttribute("SerilogExtensions.Tests")>]
[<assembly: AssemblyProductAttribute("SerilogExtensions")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "SerilogExtensions.Tests"
    let [<Literal>] AssemblyProduct = "SerilogExtensions"
